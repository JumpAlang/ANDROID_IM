...
public class VoiceViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public VoiceViewHolder(View itemView, boolean isSender) {
        ...
        mDateTv = (RoundTextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_date);
        mAvatarIv = (RoundImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_avatar);
        ...
        if (!isSender) {
            ...
            mDisplayNameTv = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_receiver_display_name);
        } else {
            mSendingPb = (ProgressBar) itemView.findViewById(cn.jiguang.imui.R.id.aurora_pb_msgitem_sending);
            mDisplayNameTv = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_sender_display_name);
        }
        mResendIb = (ImageButton) itemView.findViewById(cn.jiguang.imui.R.id.aurora_ib_msgitem_resend);
