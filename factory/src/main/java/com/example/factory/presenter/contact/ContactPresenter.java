...
//                        getView().getRecyclerAdapter().clear();
                        getView().onAdapterDataChanged();

                    }
                })
                .execute();
        UserHelper.refreshContacts(new RefreshContactsObserver());
//         加载网络数据
...
//        });
    ...
    class RefreshContactsObserver extends BaseObserver<List<UserCard>>{
